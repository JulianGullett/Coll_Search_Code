...
if rank == 0:
    ...
    ls_param_combos = list(ParameterGrid(ls_param_grid))
    landscapes = []
    for ls_comb in ls_param_combos:                       
        landscapes += nklsgen.generate_landscapes(ls_comb['N'], 
                                                  ls_comb['K'],
                                                  ls_comb['num_of_ls'])
